...
public class b4xcombobox extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xcombobox");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xcombobox.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_RaiseEvent(indoorgeolocation.aps.uvigo.b4xcombobox parent) {
this.parent = parent;
}
indoorgeolocation.aps.uvigo.b4xcombobox parent;
int _index = 0;
int _myindex = 0;
