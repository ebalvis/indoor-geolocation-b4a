...
public class b4xinputtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xinputtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xinputtemplate.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(indoorgeolocation.aps.uvigo.b4xinputtemplate parent,indoorgeolocation.aps.uvigo.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
indoorgeolocation.aps.uvigo.b4xinputtemplate parent;
