...
public class b4xcolortemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xcolortemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xcolortemplate.class).invoke(this, new Object[] {null});
        else
...
public indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart _huebar = null;
public indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart _colorpicker = null;
public indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart _alphabar = null;
public int _borderscolor = 0;
public indoorgeolocation.aps.uvigo.b4xdialog _xdialog = null;
...
int _r = 0;
int _w = 0;
indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart _cpp = null;
int _i = 0;
...
_cpp = (indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart)(group12[index12]);
...
_huebar = new indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart();
_colorpicker = new indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart();
_alphabar = new indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart();
 //BA.debugLineNum = 12;BA.debugLine="Private BordersColor As Int";
_borderscolor = 0;
 //BA.debugLineNum = 13;BA.debugLine="Private xDialog As B4XDialog";
_xdialog = new indoorgeolocation.aps.uvigo.b4xdialog();
...
public indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart  _createpanelforbitmapcreator(String _eventname,boolean _withcheckers) throws Exception{
indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart _cpp = null;
...
_cpp = new indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart();
...
public String  _drawcheckers(indoorgeolocation.aps.uvigo.b4xcolortemplate._colorpickerpart _cpp) throws Exception{
int _size = 0;
int[] _clrs = null;
int _clr = 0;
anywheresoftware.b4a.objects.B4XCanvas.B4XRect _r = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(indoorgeolocation.aps.uvigo.b4xdialog _dialog) throws Exception{
...
public void  _show(indoorgeolocation.aps.uvigo.b4xdialog _dialog) throws Exception{
ResumableSub_Show rsub = new ResumableSub_Show(this,_dialog);
rsub.resume(ba, null);
}
public static class ResumableSub_Show extends BA.ResumableSub {
public ResumableSub_Show(indoorgeolocation.aps.uvigo.b4xcolortemplate parent,indoorgeolocation.aps.uvigo.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
indoorgeolocation.aps.uvigo.b4xcolortemplate parent;
indoorgeolocation.aps.uvigo.b4xdialog _dialog;
