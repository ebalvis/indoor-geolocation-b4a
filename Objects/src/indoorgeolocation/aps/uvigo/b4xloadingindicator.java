...
public class b4xloadingindicator extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xloadingindicator");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xloadingindicator.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_MainLoop(indoorgeolocation.aps.uvigo.b4xloadingindicator parent) {
this.parent = parent;
}
indoorgeolocation.aps.uvigo.b4xloadingindicator parent;
int _myindex = 0;
long _n = 0L;
float _progress = 0f;
