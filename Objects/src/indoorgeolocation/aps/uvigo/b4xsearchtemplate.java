...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public indoorgeolocation.aps.uvigo.b4xfloattextfield _searchfield = null;
...
_searchfield = new indoorgeolocation.aps.uvigo.b4xfloattextfield();
...
__c.LogImpl("922020127","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(indoorgeolocation.aps.uvigo.b4xsearchtemplate parent,indoorgeolocation.aps.uvigo.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
indoorgeolocation.aps.uvigo.b4xsearchtemplate parent;
