...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata  _copyformatdata(indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata _data) throws Exception{
indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata _d = null;
...
_d = new indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata();
...
public indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata _d = null;
...
indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata _data = null;
...
public indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata _d = null;
...
_d = (indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
