...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.anotherprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.anotherprogressbar.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_BusyLoop(indoorgeolocation.aps.uvigo.anotherprogressbar parent) {
this.parent = parent;
}
indoorgeolocation.aps.uvigo.anotherprogressbar parent;
int _myindex = 0;
