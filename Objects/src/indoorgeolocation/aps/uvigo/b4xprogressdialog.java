...
public class b4xprogressdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xprogressdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xprogressdialog.class).invoke(this, new Object[] {null});
        else
...
public indoorgeolocation.aps.uvigo.b4xloadingindicator _loadingindicator = null;
...
_loadingindicator = new indoorgeolocation.aps.uvigo.b4xloadingindicator();
...
public String  _show(indoorgeolocation.aps.uvigo.b4xdialog _dialog) throws Exception{
