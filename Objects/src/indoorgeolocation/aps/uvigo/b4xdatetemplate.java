...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public indoorgeolocation.aps.uvigo.b4xdialog _mdialog = null;
...
_mdialog = new indoorgeolocation.aps.uvigo.b4xdialog();
...
public ResumableSub_Show(indoorgeolocation.aps.uvigo.b4xdatetemplate parent,indoorgeolocation.aps.uvigo.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
indoorgeolocation.aps.uvigo.b4xdatetemplate parent;
