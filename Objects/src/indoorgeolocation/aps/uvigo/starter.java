...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "indoorgeolocation.aps.uvigo", "indoorgeolocation.aps.uvigo.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "indoorgeolocation.aps.uvigo.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
