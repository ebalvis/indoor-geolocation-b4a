...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public indoorgeolocation.aps.uvigo.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new indoorgeolocation.aps.uvigo.b4xfloattextfield();
...
__c.LogImpl("913107224","Multiline not supported with password mode.",0);
 };
...
public indoorgeolocation.aps.uvigo.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((indoorgeolocation.aps.uvigo.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(indoorgeolocation.aps.uvigo.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((indoorgeolocation.aps.uvigo.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (indoorgeolocation.aps.uvigo.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(indoorgeolocation.aps.uvigo.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
indoorgeolocation.aps.uvigo.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((indoorgeolocation.aps.uvigo.b4xfloattextfield)(this)) == false) { 
