...
public class b4xradiobutton extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xradiobutton");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xradiobutton.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_SetValueImpl(indoorgeolocation.aps.uvigo.b4xradiobutton parent,boolean _b,boolean _immediate) {
this.parent = parent;
this._b = _b;
this._immediate = _immediate;
}
indoorgeolocation.aps.uvigo.b4xradiobutton parent;
boolean _b;
boolean _immediate;
int _i = 0;
anywheresoftware.b4a.objects.B4XViewWrapper _v = null;
indoorgeolocation.aps.uvigo.b4xradiobutton _rb = null;
int _myindex = 0;
long _start = 0L;
int _duration = 0;
float _state1 = 0f;
...
//if
this.state = 10;
if ((_v).equals(parent._mbase) == false && _v.getTag() instanceof indoorgeolocation.aps.uvigo.b4xradiobutton) { 
this.state = 9;
}if (true) break;
...
_rb = (indoorgeolocation.aps.uvigo.b4xradiobutton)(_v.getTag());
