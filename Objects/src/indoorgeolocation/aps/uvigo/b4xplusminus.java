...
public class b4xplusminus extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "indoorgeolocation.aps.uvigo.b4xplusminus");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", indoorgeolocation.aps.uvigo.b4xplusminus.class).invoke(this, new Object[] {null});
        else
...
public indoorgeolocation.aps.uvigo.b4xformatter _formatter = null;
...
_formatter = new indoorgeolocation.aps.uvigo.b4xformatter();
...
_formatter._getdefaultformat /*indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata*/ ().FormatFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = _mainlabel.getFont();
 //BA.debugLineNum = 63;BA.debugLine="Formatter.GetDefaultFormat.TextColor = MainLabel.";
_formatter._getdefaultformat /*indoorgeolocation.aps.uvigo.b4xformatter._b4xformatdata*/ ().TextColor /*int*/  = _mainlabel.getTextColor();
...
public ResumableSub_StartDownLoop(indoorgeolocation.aps.uvigo.b4xplusminus parent,boolean _up) {
this.parent = parent;
this._up = _up;
}
indoorgeolocation.aps.uvigo.b4xplusminus parent;
boolean _up;
int _myindex = 0;
